...
function convierteString (minuscula)
    {
        return console.log(minuscula.toUpperCase());
    }
convierteString ("palabra");
...
function edadDePerros (edad)
    {
        return console.log(edad * 7);
    }
edadDePerros (5);

function valorDeHora (salarioMensual,diasTrabajados,horasPorDia)
    {
        return console.log((salarioMensual/diasTrabajados)/horasPorDia);
    }
valorDeHora (100000,30,8);